...
function indagheto(){
  gamestatus="start";
  document.getElementById("tidy").innerHTML="game is loading";
}
function game(){
console.log("noseX="+noseX+",noseY"+noseY);
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press play button to Start otherwise tsar bomba will be fired to your location", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
...
function StepOnEnemy(obj1,obj2){
    ...
    obj1.killing=30;
    obj1.kills++;
    hayahhh_flying_kick_to_your_face.play();
